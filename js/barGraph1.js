globalThis.barGraphPromise = Promise.all([d3.csv('./data/all_data_earlyT.csv'),d3.csv('./data/all_data_midT.csv'), d3.csv('./data/all_data_lateT.csv'),d3.csv('./data/all_data_earlyJ.csv'),d3.csv('./data/all_data_midJ.csv'),d3.csv('./data/all_data_lateJ.csv'),d3.csv('./data/all_data_earlyK.csv'),d3.csv('./data/all_data_lateK.csv')]);
barGraphPromise.then(([earlyT,midT,lateT,earlyJ,midJ,lateJ,earlyK,lateK])=>{
        let data_collection=earlyT.concat(midT).concat(lateT).concat(earlyJ).concat(midJ).concat(lateJ).concat(earlyK).concat(lateK);
        // let data_collection=[];
        // earlyT.forEach(function (data) {
        //     data_collection.push(data);
        // });
        // midT.forEach(function (data) {
        //     data_collection.push(data);
        // });
        // lateT.forEach(function (data) {
        //     data_collection.push(data);
        // });
        // earlyJ.forEach(function (data) {
        //     data_collection.push(data);
        // });
        // midJ.forEach(function (data) {
        //     data_collection.push(data);
        // });
        // lateJ.forEach(function (data) {
        //     data_collection.push(data);
        // });
        // earlyK.forEach(function (data) {
        //     data_collection.push(data);
        // });
        // lateK.forEach(function (data) {
        //     data_collection.push(data);
        // });

        const temp_Phylum=[];
        for(let i in data_collection){
        ...
        const all_Phylum=new Set(temp_Phylum);
        ...
        const all_Class=new Set(temp_Class);
        ...
        const all_Order=new Set(temp_Order);
        ...
        const all_Family=new Set(temp_Family);
        ...
        const all_Genus=new Set(temp_Genus);
        ...
        const all_Species=new Set(temp_Species);
                         ...
                         data4.forEach(function (data5,key5) {
                             data5.forEach(function (data) {
                                 ...
                                 early_data.forEach(function (record) {
                                     if(record['Phylum']===key1 && record['Class']===key2 && record['Order']===key3 && record['Family']===key4 && record['Genus']===key5 && record['Species']===data){
                                         if(temp.length===0){
                                             temp.push(record);
                                         }else{
                                             let old_year = temp[0]["end_year"] - temp[0]["start_year"];
                                             let new_year = record["end_year"] - record["start_year"];
